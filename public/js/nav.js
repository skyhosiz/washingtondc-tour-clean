(function () {
  ...
  let left = `
    <div id="nav-left" style="display:flex;align-items:center;gap:26px;flex-wrap:wrap;">
      <a href="index.html" 
         style="font-weight:900;font-size:20px;color:#ff9650;text-decoration:none;letter-spacing:1px;">
         D.C. TOUR
      </a>`;
  links.forEach((l) => {
  ...
  if (token) {
    ...
    right += `
      <a href="login.html"
        style="background:#ff9650;color:#111;
  ...
  burger.innerHTML = `
    ...
    <div style="width:26px;height:3px;background:#fff;margin:4px 0;border-radius:2px;"></div>
    <div style="width:26px;height:3px;background:#fff;margin:4px 0;border-radius:2px;"></div>`;
  burger.style.cssText = `display:none;cursor:pointer;`;
  ...
  function handleMobile(e) {
    ...
    if (e.matches) {
      ...
      burger.onclick = () => {
        ...
        leftDiv.style.background = "rgba(0,0,0,0.9)";
